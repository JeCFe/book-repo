...
describe("Selector", () => {
  ...
  it("renders with the placeholder", () => {
    render(<Selector options={options} placeholder="Select..." onChange={undefined} />);
  ...
  it("shows 'Not available' placeholder when disabled", () => {
    render(
      <Selector options={options} placeholder="Select..." onChange={undefined} isDisabled />,
    );
  ...
  it("calls onChange with the selected value", () => {
    ...
    render(<Selector options={options} placeholder="Select..." onChange={onChange} />);
