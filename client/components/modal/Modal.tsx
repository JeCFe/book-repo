    ...
    <>
      {isOpen && (
        <>
          ...
          <div className="fixed left-1/2 top-1/2 z-50 w-11/12 max-w-lg max-h-[85vh] -translate-x-1/2 -translate-y-1/2 overflow-auto rounded-xl bg-slate-300 p-6 shadow-2xl md:p-12">
            <div className="flex w-full flex-col">
              {children}
              <div className="mt-8 border-t border-slate-400" />
              {error && (
                <div className="flex pb-4 pt-2 text-sm text-red-600">{error}</div>
              )}
